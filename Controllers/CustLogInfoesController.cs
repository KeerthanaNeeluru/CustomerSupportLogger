...
namespace CustomerSupportLogger.Controllers
{
    public class CustLogInfoesController : Controller
    {
        ...
        public CustLogInfoesController(CustomerSupportDbContext context)
        {
            _context = context;
        }
        ...
        {
            var customerSupportDbContext = _context.CustLogInfos.Include(c => c.User);
            return View(await customerSupportDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomerSupportDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
